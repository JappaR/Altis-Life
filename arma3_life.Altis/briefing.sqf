...
player createDiarySubject ["gangrules","Gangs/Rebellen"];
...
*/	
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				...
				1. Wenn du während des Roleplays oder eines Events stirbst, zählen deine begangenen Straftaten als vergessen. Du kannst jedoch auch nicht Rache ausüben.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Random Deathmatching (RDM)", 
				...
				5. Das Töten eines Spielers durch Selbstverteidigung oder zur Verteidigung anderer zählt nicht als RDM. Es zählt dennoch als Straftat!<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Verhaltensregeln", 
				...
				3. Zivilisten und Rebellen ist das Abschießen von Polizisten in Städten und auch überall sonst untersagt wenn es keinen Rollenspiel Hintergrund gibt.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Allgemeines", 
				...
				3. Komplettes Flugverbot, Start- sowie Landeverbot für Helikopter in/über Kavalla.<br/>
				4. Unfälle müssen sofort der Polizei gemeldet werden.<br/>
				5. Fahrverbot sowie Parkverbot für HEMMT's auf und um den Kavalla Marktplatz.<br/>
				6. Tempolimits:<br/>
				- 30Km/h Marktplatz Kavalla<br/>
				- 50Km/h innerorts<br/>
				- 100Km/h außerorts<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["safezones",
		[
			"Sicherheitszonen",
				"
				Das Ausrauben oder Töten innerhalb der Sicherheitszonen (+75m Umkreis) wird mit einem Ban belegt. Außnahme bei angekündigten und von einem Server Admin erlaubten Events.<br/><br/>
...
// Server Information
	...
	player createDiaryRecord ["serverinfo",
		[
			"Bugs",
				"
				Bitte meldet alle Bugs unter:<br/>
...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"Events/Aktionen",
				"
				Jede Gang sowie Rebellengruppe darf sogenannte Events starten. JEDES Event muss vorher von einem Admin genehmigt werden. Unter Events zählen z.B.:<br/><br/>
				
				1. Geiselnahmen<br/>
				2. Angriffe von Städten<br/>
				3. Kopfgelder auf Personen<br/>
				4. Einnehmen von Gebieten<br/><br/>
				
				Alle Events brauchen mehrere Ziele die erreicht werden können sowie eine bestimmte Zeitspanne. Diese Faktoren bestimmen den erfolgreichen Ausgang oder das Fehlschlagen des Events. Jedes Event soll den beteiligten Personen einen Mehrwert bieten und nicht dazu dienen sinnlos Leute zu töten.<br/><br/>
				
				Sollte eine Person die am Event teilnimmt aufgrund de Events sterben, hat diese sich für 20 Minuten vom Geschehen fernzuhalten! Diese Regel gilt auch für Polizisten welche jedoch nur 10 Minuten fernbleiben müssen.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Die Bundesbank",
				...
				8. Der Dienstvorgesetzter Polizist darf mit einzelnen Personen oder Gruppen einen Vertrag abschließen um die Bundesbank zu verteidigen.<br/>
				9. Zivilisten dürfen sich für 20 Minuten, nachdem sie bei dem Überfall gestorben sind, nicht wieder der Bundesbank nähern! Diese Regel gilt auch für Polizisten, welche jedoch nur 10 Minuten warten müssen.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				1. Um ein Gebiet zu Raiden, müssen es mindestens 2 Polizisten sein und einer von ihnen muss mindestens den Rang Sergeant oder höher haben.<br/>
				...
				8. Falls die Operation fehlschlägt (alle Polizisten sterben), gilt die 10 Minuten Regel trotzdem für diese Polizisten.<br/>
				...
				2. Camping in illegalen Gebieten ist der längere Aufhalt in dem Gebiet nach dem Raid, oder Polizisten welche keinen Raid durchführen aber ein Gebiet für längere Zeit überwachen und Zivilisten überprüfen.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Checkpoints", 
				...
				1. Ein Checkpoint besteht aus mindestens 2 Polizisten und mindestens 1 Fahrzeugen.<br/>
				...
				5. Erkläre dem Fahrer, dass er zum Personendatenabgleich kurzeitig fixiert (restrained) werden muss.<br/>
				6. Lege ihnen nun Handschellen an und durchsuche sie.<br/>
				7. Falls sie einer Fahrzeuguntersuchung nicht zustimmen, müssen sie weiter gelassen werden außer du hast einen triftigen Grund dies nicht zu tun.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Illegale Gebiete", 
				"
				1. Gang Gebiete zählen nicht zu den illegalen Gebieten. Deshalb dürfen Polizisten ein Gang Gebiet betreten ohne das es ein Raid ist, darf aber auch niemanden anhalten und festnehmen solange er keinen triftigen Grund sieht oder jemand etwas illegales macht. (Mit einem Gang NPC reden ist kein Grund oder illegale Aktivität.)<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Luftraum",
				"
				1. Es ist keinem Helikopter erlaubt innerhalb von Städten zu landen ohne die Erlaubnis vom Rang höchsten Polizisten. Zur Ausnahme zählen AAC Helikopter sowie offizielle Krankentransporte.<br/>				
	...
	player createDiaryRecord ["policerules",
		[
			"Waffen", 
				...
				Legale Waffen welche von Zivilisten mit einem Waffenschein getragen werden dürfen:<br/><br/>
				1. Rook<br/>
				2. ACP-C2<br/>
				3. 4-Five<br/>
				4. PDW2000<br/>				
	...
	player createDiaryRecord ["policerules",
		[
			"Festnahmen und Bußgelder",
				...
				1. Jemand der sein Bußgeld bezahlt hat darf nicht ins Gefängnis geschickt werden. Es sei denn bei Wiederholungstätern sowie den im Bußgeldkatalog ausgeschriebenen Ausnahmen.<br/>
				...
				1. Bußgelder sollen einen angemessenen hohen Betrag haben (siehe Bußgeldkatalog).<br/>
				...
				4. Einem Zivilisten ein unnötig hohes Ticket geben, wie zum Beispiel 100.000$ für zu schnelles Fahren, ist nicht erlaubt und führt zum Ausschluss aus dem Polizeidienst.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Bußgeldkatalog",
                "
				Die folgenden Straftaten werden mit den zugehörigen Ticketpreisen sowie ggf. zusätzlich mit einer Gefängnisstrafe geahndet:<br/><br/>
	...
	player createDiaryRecord ["gangrules",
		[
			"Rebellen Regeln",
				...
				1. Ein Rebell muss eine offizielle Gang gründen (im 'Z' Menü) und dann seine Absichten erläutern.<br/>
...
// Illegal Items Section
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegale Fahrzeuge",
				"
				Der Besitz von folgenden Fahrzeugen ist für Zivilisten verboten (Fahrzeuge werden beschlagnahmt):<br/><br/>
				1. Ifrit<br/>
				2. Sämtliche Polizeifahrzeuge<br/>
				3. Sämtliche AAC Fahrzeuge (außer für Mitarbeiter)<br/><br/>
				
				Der Besitz von folgenden Fahrzeugen ist für Zivilisten verboten (Ausschluss vom Server = Ban):<br/><br/>
				1. Sämtliche Donatorfahrzeuge sind für nicht Donator verboten!<br/><br/>
			"
		]
	];
	player createDiaryRecord ["illegalitems",
		[
			"Illegale Waffen",
				"
				Der Besitz von folgenden Waffen ist für Zivilisten verboten (Waffen werden beschlagnahmt):<br/><br/>
				1. Alle Waffen außer aus dem normalen Waffenshop (Rook, AcpC2, PDW2000) sowie die Rebellenwaffe TRG-20 und Donatorwaffe MK20C + 4-Five Pistole sind illegal.<br/><br/>
				
				Der Besitz von folgenden Waffen ist für Zivilisten verboten (Ausschluss vom Server = Ban):<br/><br/>
				1. Sämtliche Donatorwaffen sowie Donatorzubehör sind für nicht Donator verboten!<br/><br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
	...
	player createDiaryRecord ["donators",
		[
			"Wo? Wie?",
				...
				Vielen vielen Dank an sämtliche Donators! Durch euch können wir den Server am Laufen halten und immer weitere Features hinzufügen.<br/><br/>
				
				THX! Bolle/Addinator/Ren3e/Little
				"
		]
	];
	...
	player createDiaryRecord ["donators",
		[
			"Vorteile",
				...
				Bloß weil jemand den Zugang zu den Donator Waffen hat, heißt dies nicht, dass diese auch legal sind. Sämtliche Donatorwaffen sind bis auf einige Ausnahmen (siehe 'illegale Waffen') weitehin illegal.<br/>
				Zudem dürfen Vorteile die freigeschaltet werden (Waffen, Fahrzeuge usw.) nicht an andere weitergegeben bzw. verkauft werden! Dies führt zu einem Ausschluss vom Server (Ban)!<br/><br/>
				"
		]
	];